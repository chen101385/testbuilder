...
for (var prefix = 644; prefix <=649; prefix++) {
  ...
  detectNetwork('6011292429839214').should.equal('Discover');
  });

  it('has a prefix of 6011 and a length of 19', function() {
    detectNetwork('6011928482720829382').should.equal('Discover');
  });

  it('has a prefix of 65 and a length of 16', function() {
  detectNetwork('6511292429839214').should.equal('Discover');
  });

  it('has a prefix of 65 and a length of 19', function() {
  detectNetwork('6511292429839214142').should.equal('Discover');
  });
  }
});
...
describe('should support Switch too', function() {
